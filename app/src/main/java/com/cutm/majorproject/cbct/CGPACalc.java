    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                 if(Double.parseDouble(credit.getText().toString())<=10
                         && Double.parseDouble(credit.getText().toString())>=1) {
                     if (Double.parseDouble(grade.getText().toString()) <= 10
                         ...
                         grade.getText().clear();
                         Toast.makeText(com.cutm.majorproject.cbct.CGPACalc.this, "Added", Toast.LENGTH_SHORT).show();
                     }
                     else {
                         Toast.makeText(com.cutm.majorproject.cbct.CGPACalc.this, "Enter Correct Valus", Toast.LENGTH_SHORT).show();
                     }
                 }
                    ...
                    Toast.makeText(com.cutm.majorproject.cbct.CGPACalc.this, "Enter Valus", Toast.LENGTH_SHORT).show();
                }
        ...
        reset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(com.cutm.majorproject.cbct.CGPACalc.this, "Reseted", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
