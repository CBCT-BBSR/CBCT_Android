...
public class TaskListAdapter extends RecyclerView.Adapter<com.cutm.majorproject.cbct.TaskListAdapter.TaskListHolder>{
    ...
    public void onBindViewHolder(@NonNull TaskListHolder holder, int position) {
        ...
        final ArrayList<com.cutm.majorproject.cbct.Items> taskitems=Task.convertStringstoArrayList(currenttask.taskItemsStrings);
    ...
    public interface TaskitemclickListner{
        void onTaskItemClicked(com.cutm.majorproject.cbct.Items item, boolean checkedValue, Task task);
        void onupdateclicked(com.cutm.majorproject.cbct.Items item, Task task);
        void ondeleteclicked(com.cutm.majorproject.cbct.Items item, Task task);
    }
}
